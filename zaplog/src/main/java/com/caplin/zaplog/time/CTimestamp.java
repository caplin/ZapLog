...
public class CTimestamp
{
	...
	public CTimestamp()
	{
		...
		timestampsMap.add(new Timestamp("yyyy/MM/dd-HH:mm:ss.SSS Z", 2, 0)); // 2012/09/14-16:26:21.396 -0400 ||
																				// liberator logs
		timestampsMap.add(new Timestamp("yyyy MMM dd HH:mm:ss.SSS Z", 4, 0)); // 2012 Nov 21 14:40:02.529 +0000 ||
																				// CalendarService
		...
		timestampsMap.add(new Timestamp("yyyy/MM/dd HH:mm:ss.SSS Z", 2, 0)); // 2012/10/01 11:42:59.632 -0400 || refiner
																				// logs
